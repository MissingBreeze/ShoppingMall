...
export default {
  ...
  methods: {
    ...
    openForm(id) {
      ...
      if (id) {
        this.$http.post('/ShoppingMall/ProductType/BasicProductType/GetTheData', { id: id }).then(resJson => {
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.$http.post('/ShoppingMall/ProductType/BasicProductType/SaveData', this.entity).then(resJson => {
