...
export default {
  ...
  methods: {
    ...
    openForm(id, title) {
      ...
      if (id) {
        this.loading = true
        this.$http.post('/ShoppingMall/ProfitSet/BasicProfitSet/GetTheData', { id: id }).then(resJson => {
          this.loading = false
    ...
    handleSubmit() {
      this.$refs['form'].validate(valid => {
        ...
        this.loading = true
        this.$http.post('/ShoppingMall/ProfitSet/BasicProfitSet/SaveData', this.entity).then(resJson => {
          this.loading = false
